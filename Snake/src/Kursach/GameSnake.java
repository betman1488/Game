...
public class GameSnake {
    ...
    final int START_DIRECTION = RIGHT; //начальное направление
    ...
    void go() {
        ...
        frame.getContentPane().add(BorderLayout.CENTER, canvasPanel); //добавляет конвас на панель
